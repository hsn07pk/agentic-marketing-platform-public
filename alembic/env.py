...
Uses synchronous driver for migration operations.
"""
...
# Get database URL from environment, ensuring we use sync driver
database_url = os.getenv(
    "DATABASE_URL",
    "postgresql://agentic:changeme@localhost:5432/agentic"
)

# Remove async driver suffix if present (asyncpg -> psycopg2)
